        ...
        >
          {slides.map((slide, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex flex-col items-center gap-2 rounded-3xl shadow-[4px_4px_4px_0px_#00000025] px-6 py-4 transition-all duration-500 ease-in-out w-full max-w-[338px] scale-90 opacity-90 ${
                    isCenter
                ...
                >
                  <Image
                    ...
                    height={200}
                    alt={slide.name}
                    className={`rounded-full object-cover duration-300 h-20 w-20 -mt-10 ${
